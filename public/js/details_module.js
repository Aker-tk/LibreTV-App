async function showDetails(id, vod_name, sourceCode) {
  ...
  try {
    ...
    const requestOptions = {
      ...
      timeout_secs: 15
      // Example timeout for detail requests
    };
    ...
    modalTitle.innerHTML = '<span class="break-words">'.concat(safeVodName, "</span>").concat(sourceNameSpan);
